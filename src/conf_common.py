...
# -*- coding: utf-8 -*-
#
# EBCWA documentation build configuration file, created by
# sphinx-quickstart on Sat Jul 20 14:38:17 2013.
#
...
extensions = ['sphinx.ext.intersphinx', 'sphinx.ext.ifconfig', 'bible_domain']

# Add any paths that contain templates here, relative to this directory.
templates_path = ['_templates']

primary_domain = 'bible'
bible_version = 'ESV'
draft = False
standalone = True
...
exclude_patterns = ['_build', 'src', '*/*/doctrines']
...
man_pages = [
    ('index', 'ebcwa', 'EBCWA Documentation',
     ['EBCWA'], 1)
]
...
texinfo_documents = [
  ('index', 'EBCWA', 'EBCWA Documentation',
   'EBCWA', 'EBCWA', 'One line description of project.',
   'Miscellaneous'),
]
